...
```{r curvewise_ribbon, fig.width = tiny_width, fig.height = tiny_height}
df %>%
  group_by(x) %>%
...
```{r pointwise_curvewise, fig.width = tiny_width, fig.height = tiny_width}
...
```{r mtcars_curve_interval, fig.width = tiny_width, fig.height = tiny_height}
mtcars_boot %>%
  group_by(mpg) %>%
...
```{r mtcars_curve_interval_bd, fig.width = tiny_width, fig.height = tiny_height, eval = requireNamespace("fda", quietly = TRUE)}
mtcars_boot %>%
  group_by(mpg) %>%
