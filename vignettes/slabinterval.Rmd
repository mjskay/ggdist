...
df %>%
  ...
  sample_n(50) %>%
  ggplot(aes(y = group, x = value)) +
  stat_slab(scale = 0.5, position = "dodge") +
  stat_dotsinterval(side = "bottom", scale = 0.5, position = "dodge") +
  labs(title = 'stat_slab(scale = 0.5) + \nstat_dotsinterval(scale = 0.5, side = "bottom")')
```
