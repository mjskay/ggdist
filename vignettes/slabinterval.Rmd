...
```{r halfeyeh_family, fig.width = med_width, fig.height = med_width}
p = df %>%
  ggplot(aes(x = group, y = value)) +
  panel_border()
...
```{r stat_histintervalh, fig.width = med_width, fig.height = small_height}
p = df %>%
  ggplot(aes(x = group, y = value)) +
  panel_border()
...
```{r dist_dots_shape_color, fig.width = med_width, fig.height = small_height}
dist_df %>%
