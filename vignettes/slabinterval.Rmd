...
dists_plot = dists_df %>%
  ...
  stat_dist_heapintervalh(data = . %>% filter(geom == "heapinterval[h]"), position = position_nudge(y = - 0.3)) +
  stat_dist_heaph(data = . %>% filter(geom == "heap[h]"), position = position_nudge(y = - 0.3)) +
...
annotation_plot = tribble(
    ...
    "heapinterval[h]",     c("stat_...", "stat_dist_...", "geom_..."),
    "heap[h]",             c("stat_...", "stat_dist_...", "geom_..."),
