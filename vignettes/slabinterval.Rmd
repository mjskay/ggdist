...
```{r stat_histintervalh, fig.width = 5, fig.height = 3}
p = df %>%
  ggplot(aes(x = group, y = value)) +
  panel_border()
...
plot_grid(ncol = 2, align = "hv",
  p + stat_histinterval(slab_color = "red", outline_bars = FALSE) + labs(title = "stat_histinterval[h]", subtitle = "stat_histinterval()"),
  ph + stat_histintervalh(slab_color = "red", outline_bars = TRUE) + labs(subtitle = "stat_histintervalh()")
)
```
