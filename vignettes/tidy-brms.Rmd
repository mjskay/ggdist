...
Another way to look at these posterior predictions might be as a scatterplot matrix. `tidybayes::gather_pairs` makes it easy to generate long-format data frames suitable for creating custom scatteplot matrices (or really, arbitrary matrix-style small multiples plots) in ggplot using `facet_grid`:
