...
The dots+interval stats and geoms are a flexible sub-family for creating dotplots and beeswarms. They support several useful layouts (including the classic Wilkinson dotplot layout, a hexagonal layout, a weave layout, a bar/waffle plot layout, and several variations on beeswarm layouts). The geoms can automatically select the dot size so that the dots stay within the bounds of the plot.
