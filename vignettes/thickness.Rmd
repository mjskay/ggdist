...
**Note**: this article makes use of ggdist subguides for labeling purposes, which
are currently only available in the development version of ggdist (> 3.3.1) on Github.
...
scale_plot = function(scale = 0.9) {
  data.frame(d = dist_normal(c(4,5)), y = c("a","b")) %>%
