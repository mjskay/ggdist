...
This vignette describes how to use the `tidybayes` package to extract [tidy data](http://dx.doi.org/10.18637/jss.v059.i10) data frames of samples of parameters, fits, and predictions from `rstanarm`. For a more general introduction to `tidybayes` and its use on general-purpose sampling languages (like Stan and JAGS), see <code>[vignette("tidybayes")](tidybayes.html)</code>.
