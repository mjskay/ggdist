...
Matthew Kay (`r format(Sys.Date(), "%Y")`). _ggdist: Distribution and Uncertainty Visualization_. R package version `r getNamespaceVersion("ggdist")`, <https://mjskay.github.io/ggdist/>. DOI: [10.5281/zenodo.3879620](https://doi.org/10.5281/zenodo.3879620).
