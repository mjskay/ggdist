...
test_that("lineribbon aesthetic documention generator works", {
  ...
  geom_output = paste0(rd_lineribbon_aesthetics("lineribbon"), collapse = "\n")
  ...
  geom_stat_output = paste0(rd_lineribbon_aesthetics("lineribbon", stat = StatLineribbon), collapse = "\n")
