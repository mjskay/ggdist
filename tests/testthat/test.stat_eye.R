...
test_that("dodged eye plots work", {
  ...
  vdiffr::expect_doppelganger("vert slab, dodge, 3 groups, just = 0, default, scale = 1.5",
    p + stat_slab(aes(fill = g), position = "dodge", scale = 1.5, n = 20)
  )

  vdiffr::expect_doppelganger("vert slab, dodge, 3 groups, just = 0, bottom, scale = 1.5",
