...
#'
#' Extract samples from the result of a call to \code{\link[lsmeans]{lsmeans}} or \code{\link[lsmeans]{ref.grid}} applied to
#' a Bayesian model.
#'
...
#' \code{\link[MCMCglmm]{MCMCglmm}}. Given a \code{\link[lsmeans]{ref.grid}} object as returned by functions like
...
#' the marginal posterior distributions generated by \code{\link[lsmeans]{lsmeans}}.
#'
#' @param object A \code{\link[lsmeans]{ref.grid}} object such as returned by \code{\link[lsmeans]{ref.grid}} or
...
#'
#' @author Matthew Kay
#' @seealso \code{\link[lsmeans]{lsmeans}}
#' @keywords manip
#' @examples
#'
#' ##TODO
