...
#'
#' Extract draws from the result of a call to \code{\link[emmeans]{emmeans}} (formerly `lsmeans`)
...
#' @param grid If `object` is an \code{\link[emmeans]{emm_list}}, the name of the output column to use to contain the name of the
...
#'
#' If `object` is an \code{\link[emmeans]{emm_list}}, which contains estimates from different reference grids,
