...
#' prediction curve).
#'
#' **This function is deprecated.** Use \code{\link[modelr]{data_grid}} combined
...
#' \code{\link{density_bins}}, `predict_curve` has the same set of columns
#' as above, except that in place of the `lhs` column is a set of columns
#' named `lhs.x` for every column named `x` returned by
#' `summary`. For example, \code{\link{density_bins}} returns a data frame
