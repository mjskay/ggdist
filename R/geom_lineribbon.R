...
#'
#' `geom_lineribbon` is a combination version of a \code{\link{geom_line}}, and `geom_ribbon` designed for use
#' with output from \code{\link{point_interval}}. This geom sets some default aesthetics equal to the `.lower`,
#' `.upper`, and `.width` columns generated by the `point_interval` family of functions, making them
...
#' `aes(ymin = .lower, ymax = .upper, forcats::fct_rev(ordered(.width)))`.
#'
