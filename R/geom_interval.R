...
#' its default aesthetics are \code{aes(xmin = conf.low, xmax = conf.high, color = fct_rev(ordered(.prob)))}.
#'
...
geom_interval <- function(mapping = NULL, data = NULL,
  ...
  default_computed_aesthetics = aes(ymin = conf.low, ymax = conf.high, color = forcats::fct_rev(ordered(.prob)))
